...
converter = Converter(seedname=seedname, hdf_filename=seedname+'_hloc_diag.out.h5',
...
converter = Converter(seedname=seedname, hdf_filename=seedname+'_wannier.out.h5',
...
# test add_lambda
seedname = subfolder+'LaVO3-Pnma'
converter = Converter(seedname=seedname, hdf_filename=seedname+'_lambda.out.h5',
